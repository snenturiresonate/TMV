...
exports.config = {
  ...
  params: {
    ...
    trainslist_database_port: '8351',
    unscheduledtrainslist_database_port: '8352',
    trainslist_database_name: 'trains_list_repository',
    unscheduledtrainslist_database_name: 'unscheduled_trains_list_repository',
  ...
  capabilities: {
    browserName: 'chrome',
    chromeOptions: {
      args: [ "--headless", "--disable-gpu", "--window-size=1980,1080", "--shm-size=2gb" ],
      prefs: {
        download: {
  ...
  cucumberOpts: {
    ...
    format: [require.resolve('cucumber-pretty'), `json:.tmp/results-${Math.random()}.json`],
