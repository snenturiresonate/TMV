Feature: 51351 - Administration Login Message Part 2 - full end to end testing
  ...
  Scenario: 33767-8 Editing Log in Message
    When I update login settings 'Message' as 'I am a message'
    And I update login settings 'Terms and Conditions' as 'I am terms and conditions'
    Then I should see the login settings 'Message' as 'I am a message'
    And I should see the login settings 'Terms and Conditions' as 'I am terms and conditions'
  ...
  Scenario: 33767-13 Saving changes - Message
    When I update login settings 'Message' as 'I am a message'
    And the unsaved indicator is displayed on the sign in message tab
  ...
  Scenario: 33767-13 Saving changes - T&C
