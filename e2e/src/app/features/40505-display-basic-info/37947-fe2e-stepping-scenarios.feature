Feature: 37947 - Basic UI - full end to end testing - stepping scenarios
  ...
  Scenario: 40505-3 - cancellation of train description
    #    Given a berth that exists on the map is displaying a train description
    #    And it is not a Q berth
  ...
  Scenario: 40505-3 - cancellation of a duplicate train description
    Given berth '0099' in train describer 'D3' contains '' and is visible
  ...
  Scenario: 40505-5 - berth step via cancellation and interpose
  ...
  Scenario: 40505-5 - berth step - train description already in second berth, so overridden
    Given berth '0099' in train describer 'D3' contains '' and is visible
    And berth '0115' in train describer 'D3' contains '' and is visible
    And the following berth interpose message is sent from LINX
      | timestamp | toBerth | trainDescriber| trainDescription |
  ...
  Scenario: 40505-5 - berth step - out of sequence
    Given berth '0099' in train describer 'D3' contains '' and is visible
    And berth '0115' in train describer 'D3' contains '' and is visible
  ...
  Scenario: 40505-5 - berth step - both berths not on the map
    Given berth '0099' in train describer 'D3' contains '' and is visible
    And berth '0115' in train describer 'D3' contains '' and is visible
    When the following berth interpose message is sent from LINX
      | timestamp | toBerth | trainDescriber| trainDescription |
  ...
  Scenario: 40505-5 - berth step - only from berth is on the map - cancellation
    Given berth '0099' in train describer 'D3' contains '' and is visible
    And berth '0115' in train describer 'D3' contains '' and is visible
    When the following berth interpose message is sent from LINX
      | timestamp | toBerth | trainDescriber| trainDescription |
  ...
  Scenario: 40505-5 - berth step - only to berth is on the map - interpose
    Given berth '0099' in train describer 'D3' contains '' and is visible
    And berth '0115' in train describer 'D3' contains '' and is visible
    When the following berth interpose message is sent from LINX
      | timestamp | toBerth | trainDescriber| trainDescription |
